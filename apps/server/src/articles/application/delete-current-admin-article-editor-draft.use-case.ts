...
@Injectable()
class DeleteCurrentAdminArticleEditorDraftUseCase {
  constructor(
  ...
  execute(input: { articleId?: string | null; ownerUserId: string }) {
    return this.articleEditorDraftRepository.deleteCurrent({
...
export { DeleteCurrentAdminArticleEditorDraftUseCase };
